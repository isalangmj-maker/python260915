...
#창이 오픈되고 3초를 대기한다. 
time.sleep(3)
<textarea id="input" autocomplete="off" part="searchbox-input" spellcheck="false" role="combobox" aria-controls="matches" aria-live="polite" aria-expanded="false" aria-description="" placeholder="Google에 물어보기"></textarea>
